...
//        impl Shl<$f> for ArbitraryWrapping<$t, $u, $v> {
//            type Output = ArbitraryWrapping<$t, $u, $v>;
//
//            #[inline]
//            fn shl(self, other: $f) -> ArbitraryWrapping<$t, $u, $v> {
//                if other < 0 {
//                    ArbitraryWrapping(self.0.wrapping_shr((-other & self::shift_max::$t as $f) as u32))
//                } else {
//                    ArbitraryWrapping(self.0.wrapping_shl((other & self::shift_max::$t as $f) as u32))
//                }
//            }
//        }
//        forward_ref_binop! { impl Shl, shl for ArbitraryWrapping<$t, $u, $v>, $f,
//        }
//
//        impl ShlAssign<$f> for ArbitraryWrapping<$t, $u, $v> {
//            #[inline]
//            fn shl_assign(&mut self, other: $f) {
//                *self = *self << other;
//            }
//        }
//        forward_ref_op_assign! { impl ShlAssign, shl_assign for ArbitraryWrapping<$t, $u, $v>, $f }
//
//        impl Shr<$f> for ArbitraryWrapping<$t, $u, $v> {
//            type Output = ArbitraryWrapping<$t, $u, $v>;
//
//            #[inline]
//            fn shr(self, other: $f) -> ArbitraryWrapping<$t, $u, $v> {
//                if other < 0 {
//                    ArbitraryWrapping(self.0.wrapping_shl((-other & self::shift_max::$t as $f) as u32))
//                } else {
//                    ArbitraryWrapping(self.0.wrapping_shr((other & self::shift_max::$t as $f) as u32))
...
//            }
//        }
//        forward_ref_binop! { impl Shr, shr for ArbitraryWrapping<$t, $u, $v>, $f,
//        }
//
//        impl ShrAssign<$f> for ArbitraryWrapping<$t, $u, $v> {
//            #[inline]
//            fn shr_assign(&mut self, other: $f) {
//                *self = *self >> other;
//            }
//        }
//        forward_ref_op_assign! { impl ShrAssign, shr_assign for ArbitraryWrapping<$t, $u, $v>, $f }
//    };
//}
//
//#[macro_export]
